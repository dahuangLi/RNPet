...
class CaptchaContainer extends Component {
    static displayName = 'CaptchaContainer';
    ...
    render() {
        ...
        >
            ...
            >
                ...
                >
                    <WebView opacity={0} source={{ html: staticHtml }} injectedJavaScript={patchPostMessageJsCode} javaScriptEnabled={true} style={styles.sibling}
                        onMessage={(e) => {
                            this.props.callbackfn && this.props.callbackfn(e.nativeEvent.data.data);
                            console.log(e.nativeEvent.data);
                            this.props.sibling.destroy();
                        }}
                    ></WebView>
                </Animated.View>
            </TouchableWithoutFeedback>
