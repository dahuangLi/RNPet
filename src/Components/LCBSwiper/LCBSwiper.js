...
import VertViewPager from './VerticalViewPager';
import AndroidVerticalInnerScrollSwiper from './AndroidVerticalInnerScrollSwiper';
...
export default class extends Component {
  ...
  scrollBy = (index, animated = true) => {
      if (Platform.OS === 'android' && this.props.supportInnerScroll){
          this.swiper && this.swiper.scrollBy(index, animated);
      } else {
  ...
  render () {
      ...
      return Platform.OS === 'android' && this.props.supportInnerScroll ? <AndroidVerticalInnerScrollSwiper {...this.props} ref={ref => this.swiper = ref}>
      </AndroidVerticalInnerScrollSwiper> : (
    ...
    setContentHeight = (containerHeight, contentHeight, index) => {
        if (Platform.OS === 'android' && this.props.supportInnerScroll){
            this.swiper && this.swiper.setContentHeight(containerHeight, contentHeight, index);
        }
    };

    childOnScrollEndDrag = (e) => {
        if (Platform.OS === 'android' && this.props.supportInnerScroll){
            this.swiper && this.swiper.childOnScrollEndDrag(e);
        }
    };
}
