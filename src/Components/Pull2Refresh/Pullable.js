...
const defaultTopIndicatorHeight = Deviceinfo.isIphoneX() ? 90 : 60; //顶部刷新指示器的高度
    ...
    defaultTopIndicatorRender(pulling, pullok, pullrelease) {
        ...
        return (
            <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'center', height: defaultTopIndicatorHeight}}>
                ...
                <Text ref={(c) => {this.txtPullok = c;}} style={styles.hide}>    释放刷新</Text>
                <Text ref={(c) => {this.txtPullrelease = c;}} style={styles.hide}>    刷新中</Text>
            </View>
        );
    }
}
